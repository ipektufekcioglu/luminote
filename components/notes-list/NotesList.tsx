...
export default function NotesList({ children }: { children: React.ReactNode }) {
  ...
  return isAllNotes || isAllArchived || isSearch ? (
    <div className="w-full h-full lg:flex lg:flex-col lg:w-72 flex-shrink-0 bg-background px-4 py-4 lg:border-b-2 lg:border-r-2 border-border overflow-hidden">
    ...
    <div className="hidden w-full h-full lg:flex lg:flex-col lg:w-72 flex-shrink-0 bg-background px-4 py-4 lg:border-b-2 lg:border-r-2 border-border overflow-hidden">
